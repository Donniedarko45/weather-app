    ...
    <nav className="bg-gray-900 text-white shadow-lg">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          <Link to="/" className="text-3xl font-semibold tracking-tight bg-clip-text text-sky-800">
            Agro-AI Dashboard
          </Link>
          
          <div className="hidden text-4xl  md:flex space-x-4">
            <NavLink className="text-2xl" to="/weather">Weather</NavLink>
            <NavLink  className="text-2xl" to="/crop-prediction">Crop Prediction</NavLink>
        ...
        {isOpen && (
          <div className="md:hidden py-4">
            <div className="flex flex-col space-y-2">
              ...
              <NavLink to="/nasa" onClick={toggleMenu}>NASA Data</NavLink>
              <NavLink to="/crop-prediction" onClick={toggleMenu}>Crop Prediction</NavLink>
