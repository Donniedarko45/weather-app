      ...
      <div className="w-full max-w-lg bg-gray-800/70 backdrop-blur-lg border border-gray-700 rounded-lg shadow-lg z-10">
        <div className="p-6">
          ...
          <p className="text-gray-300 mb-6">
            Get accurate weather forecasts to plan your agricultural activities effectively. Our data helps you make informed decisions for crop management and farm operations.
          </p>
